const data = [
	...
	{
		id: 3,
		question: "What are the major Symptoms of Deep Vein Thrombosis?",
		answer: "DVT is difficult medical condition to identify as many patients (50%) may not display any symptoms. Also, the symptoms are more generic and are shared among various medical conditions. Patients may not be aware of DVT till they experience a serious life-threatening medical incidence like pulmonary embolism. Some of the common symptoms are:",
		list: [
	...
	{
		id: 5,
		question: "How Deep Vein Thrombosis (DVT) is Diagnosed?",
		answer: "Primary evaluation of DVT is done by conducting a physical evaluation by medical professional. Clinical confirmation of DVT is done by performing some of the below mentioned tests as required by the medical doctor.",
		list: [
	...
	{
		id: 6,
		question: "Treatment of Deep Vein Thrombosis",
		answer: "",
		 list: [
	...
	{
		id: 8,
		question: "How to Prevent Deep Vein Thrombosis (DVT)/ Precautions along treatment",
		answer: "While nothing much can be done to change the heredity, risk of developing Deep Vein Thrombosis can be greatly reduced by adopting a healthy and active lifestyle.",
		list: [
				"Regular exercise",
				"No Smoking",
	...
	{
		id: 9,
		question: "Follow-up After Endovascular DVT Management",
		answer: "Patients are anticoagulated post procedure with unfractionated heparin or low-molecular-weight heparin and transitioned to oral warfarin/ Newer anticoagulatns for 6 months (goal international normalized ratio 2.0–3.0). Patients with recurrent DVT or hypercoagulable disorders may require a longer duration of anticoagulation and consultation with primary care physicians is recommended. Patients with venous stents require lifelong aspirin therapy. Follow-up with duplex ultrasonography is also recommended at 1- and 6-month intervals and yearly thereafter.",
		//imagePath: "../img/card1.jpg"
	},
	{
		id: 10,
