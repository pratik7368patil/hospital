const data = [
	...
	},
	{
		...
		answer: "Every patient’s situation is different, and it is not always easy to predict how complex or how straightforward the procedure will be. Some uterine fibroid embolisations do not take very long, perhaps half an hour. Other embolisations may be more involved, and take rather longer, perhaps an hour. As a guide, expect to be in the X-ray department for about two hours.", 
		//imagePath: "../img/card1.jpg"
	},
	{
		id: 7,
		question: "Are there any risks or complications?",
		answer: "Uterine fibroid embolisation is a safe procedure, but there are some risks and complications that can arise, as with any medical treatment."+
